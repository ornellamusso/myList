package com.example.mylist.data.providers
...
fun getContentValues(task: Task): ContentValues {
    return ContentValues().apply {
        ...
        put(com.example.mylist.data.entities.Task.COLUMN_NAME_ALL_DAY, task.allDay)
        put(Task.COLUMN_NAME_DATE, task.date)
        put(com.example.mylist.data.entities.Task.COLUMN_NAME_TIME, task.time)
...
fun findById(id: Long) : com.example.mylist.data.entities.Task? {
    open()
